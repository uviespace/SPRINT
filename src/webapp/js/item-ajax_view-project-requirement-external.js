...
/* manage data list */
function manageData() {
    console.log("2# "+url+'api/getData_view-project-requirement-external.php?idProject='+idProject+'&idReqList='+idReqList);
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-project-requirement-external.php?idProject='+idProject+'&idReqList='+idReqList,
		data: {page:page}
	}).done(function(data){
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_view-project-requirement-external.php',
		data:{id:id}
	}).done(function(data){
        if (data['status'] == 1001) {
