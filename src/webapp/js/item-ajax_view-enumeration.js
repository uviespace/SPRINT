...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-enumeration.php?idStandard='+idStandard,
		data: {page:page}
	}).done(function(data){
...
function manageDataAll() {
	...
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-enumeration.php?idStandard='+idStandard+'&showAll=1',
		data: {page:page}
	}).done(function(data){
		total_page = 1;
		current_page = page;
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_view-enumeration.php',
		data:{id:id}
	}).done(function(data){
		c_obj.remove();
