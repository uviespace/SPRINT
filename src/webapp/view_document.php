...
<html>
<head>
	<title>CORDET Editor - Documents</title>
	...
	<script type="text/javascript" src="js/item-ajax_view-document.js"></script>
</head>
<body>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form data-toggle="validator" action-data="api/create_view-document.php" method="POST">
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-document.php" method="put">
