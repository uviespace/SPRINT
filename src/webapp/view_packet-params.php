...
<head>
	...
	<script type="text/javascript" src="js/item-ajax_view-packet-params.js"></script>
</head>
<body>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form data-toggle="validator" action-data="api/create_view-packet-params.php" method="POST">
						...
						<div class="form-group">
							...
							<select id="sel_role" name="role" class="form-control" data-error="Please enter role." >
								...
								<option value="3">Discriminant</option>
							</select>
							-->
							<div class="help-block with-errors"></div>
						</div>
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-packet-params.php" method="put">
