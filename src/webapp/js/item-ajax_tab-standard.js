...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_tab-standard.php',
		data: {page:page}
	}).done(function(data){
...
$(".crud-submit").click(function(e){
    ...
    if(id != '' && idProject != '' && name != '' && desc != ''){
        $.ajax({
            dataType: 'json',
            type:'POST',
            url: url + form_action,
            data:{id:id, idProject:idProject, name:name, desc:desc, setting:setting}
        }).done(function(data){
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_tab-standard.php',
		data:{id:id}
	}).done(function(data){
		c_obj.remove();
...
$("body").on("click",".edit-item",function(){
    ...
    var id = $(this).parent("td").data('id');
    var idProject = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").text();
