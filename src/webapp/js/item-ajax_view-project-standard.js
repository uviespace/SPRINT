...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-project-standard.php?idProject='+idProject,
		data: {page:page}
	}).done(function(data){
...
function manageDataAll() {
	...
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-project-standard.php?idProject='+idProject+'&showAll=1',
		data: {page:page}
	}).done(function(data){
		total_page = 1;
		current_page = page;
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_view-project-standard.php',
		data:{id:id}
	}).done(function(data){
		c_obj.remove();
