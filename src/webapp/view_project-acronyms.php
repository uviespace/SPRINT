...
<head>
	...
	<script type="text/javascript" src="js/item-ajax_view-project-acronym.js"></script>
	<style type="text/css">
		...
		<div class="row">
		    <div class="col-lg-12 margin-tb">
		        <div class="pull-left">
		            ...
		            <h2>Document Management - Acronyms</h2>
		        </div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form data-toggle="validator" action-data="api/create_view-project-acronym.php" method="POST">
						...
						<div class="form-group">
							...
							<select id="sel_acronym_create" name="idAcronym_create" class="form-control" onchange="updateDivAcronymCreate();" data-error="Please enter organisation." required>
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-project-acronym.php" method="put">

		      			<input type="hidden" name="id" class="edit-id">

						<div class="form-group">
							<label class="control-label" for="title">Acronym:</label>
							<select id="sel_acronym" name="idAcronym" class="form-control" onchange="updateDivAcronym();" data-error="Please enter acronym." required>
								<option value="select"></option>
							</select>
							<div class="help-block with-errors"></div>
						</div>
