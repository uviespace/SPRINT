...
<html>
<head>
	<title>CORDET Editor - Datatypes</title>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form data-toggle="validator" action-data="api/create_view-type.php" method="POST">
						...
						<div class="form-group">
							<label class="control-label" for="title">Native Type:</label>
							<input type="text" name="nativeType" class="form-control" data-error="Please enter native type." />
							<div class="help-block with-errors"></div>
						</div>

						<div class="form-group">
							<label class="control-label" for="title">Size:</label>
							<input type="text" name="size" class="form-control" data-error="Please enter size." required />
							<div class="help-block with-errors"></div>
						</div>

<!--
						<div class="form-group">
							<label class="control-label" for="title">PUS Data Type:</label>
-->
							<!--<input type="text" name="type" class="form-control" data-error="Please enter PUS data type." required />-->
<!--
							<select id="sel_pusdatatype" name="type" class="form-control" data-error="Please enter PUS data type." required>
...
-->
						...
						<div class="form-group">
							<label class="control-label" for="title">Ground System:</label>
							<select id="gse" name="kind" class="form-control" data-error="Please enter ground system." required>
								<option value="0" selected>SCOS-2000</option>
								<option value="1">EGS-CC (Common Core)</option>
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-type.php" method="POST">
						...
						<div class="form-group">
							<label class="control-label" for="title">Size:</label>
							<input id="fsize" type="text" name="size" class="form-control" onfocusout="updateDivPusdatatype();" data-error="Please enter size." />
							<div class="help-block with-errors"></div>
						</div>

						<div id="ptf" style="display: block;" class="form-group">
							<label class="control-label" for="title">Param. Type/Format:</label>
							<!--<input type="text" name="pusdatatype" class="form-control" data-error="Please enter parameter type/format." required />-->
							<select id="sel_pusdatatype" name="pusdatatype" class="form-control" data-error="Please enter parameter type/format." required>
								<option value="select"></option>
							</select>
							<div class="help-block with-errors"></div>
						</div>
