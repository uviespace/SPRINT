...
<head>
	<title>CORDET Editor - TC Header</title>
	...
	<script type="text/javascript" src="js/item-ajax_view-tcheader.js"></script>
</head>
<body>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form data-toggle="validator" action-data="api/create_view-tcheader.php" method="POST">
						...
						<div class="form-group">
							<input type="hidden" name="type" value="0" /> <!-- for TC header -->
						</div>

						<div class="form-group">
							<label class="control-label" for="title">Parameter:</label>
							<select id="sel_parameter_tc_create" name="parameter" class="form-control" data-error="Please enter parameter." required>
						...
						<div class="form-group">
							...
							<select id="sel_role_tc_create" name="role" class="form-control" data-error="Please enter role." required >
								<option value="select"></option>
							</select>
							<div class="help-block with-errors"></div>
						</div>
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-tcheader.php" method="put">
						...
						<div class="form-group">
							...
							<select id="sel_parameter_tc" name="parameter" class="form-control" data-error="Please enter parameter." required readonly>
								<option value="select"></option>
							</select>
							<div class="help-block with-errors"></div>
						</div>
						...
						<div class="form-group">
							...
							<select id="sel_role_tc" name="role" class="form-control" data-error="Please enter role.">
								<option value="select"></option>
							</select>
							<div class="help-block with-errors"></div>
						</div>
