...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-packet-params.php?idStandard='+idStandard+'&idPacket='+idPacket,
		data: {page:page}
	}).done(function(data){
...
function manageDataAll() {
	...
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-packet-params.php?idStandard='+idStandard+'&idPacket='+idPacket+'&showAll=1',
		data: {page:page}
	}).done(function(data){
		total_page = 1;
		current_page = page;
