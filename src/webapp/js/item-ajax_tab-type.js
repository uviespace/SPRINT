...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_tab-type.php',
		data: {page:page}
	}).done(function(data){
...
$(".crud-submit").click(function(e){
    ...
    if(id != '' && idStandard != '' && domain != '' && name != '' && nativeType != '' && 
       desc != '' && size != '' && value != '' && setting != '' && schema != ''){
        $.ajax({
            dataType: 'json',
            type:'POST',
            url: url + form_action,
            data:{id:id, idStandard:idStandard, domain:domain, name:name, nativeType:nativeType, 
            desc:desc, size:size, value:value, setting:setting, schema:schema}
        }).done(function(data){
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_tab-type.php',
		data:{id:id}
	}).done(function(data){
		c_obj.remove();
