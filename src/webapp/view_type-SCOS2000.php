...
<head>
	...
	<script type="text/javascript" src="js/item-ajax_view-type-SCOS2000.js"></script>
</head>
<body>
				...
				<div class="modal-body">
					<form data-toggle="validator" action-data="api/create_view-type.php" method="POST">
						...
						<div class="form-group">
							...
							<input type="text" name="size" class="form-control" data-error="Please enter size." />
							<div class="help-block with-errors"></div>
						</div>
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-type.php" method="put">
