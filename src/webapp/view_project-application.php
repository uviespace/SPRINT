...
<head>
	<title>CORDET Editor - Applications</title>
	...
	<script type="text/javascript" src="js/item-ajax_view-project-application.js"></script>
</head>
<body>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form data-toggle="validator" action-data="api/create_view-project-application.php" method="POST">

						<!--<div class="form-group">
							<label class="control-label" for="title">Name:</label>-->
							<input type="text" name="idProject" value="<?php echo $idProject; ?>" hidden />
						...
						<div class="form-group">
							...
							<textarea name="desc" class="form-control" data-error="Please enter description." rows="4"></textarea>
							<div class="help-block with-errors"></div>
						</div>
						...
						<div class="form-group">
							...
							<textarea name="setting" class="form-control" data-error="Please enter setting." rows="6"></textarea>
							<div class="help-block with-errors"></div>
						</div>
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-project-application.php" method="put">
