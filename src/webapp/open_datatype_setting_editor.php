...
if (isset($_GET["id"])) { $idType  = $_GET["id"]; } else { $idType=0; };
...
<head>
	<title>Datatype <?php echo $type_name;?> </title>
    ...
    <script src='int/json_editor_type.js'></script>
	...
	<script type="text/javascript">
		function buildProject(idProject, idStandard) {
			toastr.success('Debug: Project: '+idProject+', standard: '+idStandard, 'Success Alert', {timeOut: 5000}); 
...
<h2>Editor for Datatype <?php echo $type_name; ?></h2>
...
-->
    ...
    <div class='row'>
        <div class='col-md-12'>
<?php
            echo "<div id='editor_holder_type'></div>";
?>
        </div>
    </div>
...
<?php include 'logos.php'; ?>
					...
					?>
					<br/><br/>
					<a class="a_btn" href="view_type.php?idProject=<?php echo $idProject; ?>&idStandard=<?php echo $idStandard; ?>" target="_self">>> BACK <<</a>
					<br/>
