...
function manageOptionPacketParameter(data, id) {
	$("#sel_parameter_tc").empty();
	$.each( data, function( key, value ) {
		if (id==value.id) {
			$("#sel_parameter_tc").append('<option value="'+value.id+'" selected>'+value.domain+' / '+value.name+' ('+value.id+')</option>');
		} else {
			$("#sel_parameter_tc").append('<option value="'+value.id+'">'+value.domain+' / '+value.name+' ('+value.id+')</option>');
		}
	});
}
...
function manageOptionHeaderRole(data, role) {
	...
	$.each( data, function( key, value ) {
		if (role==value.id) {
			$("#sel_role_tc").append('<option value="'+value.id+'" selected>'+value.id+' ('+value.name+')</option>');
		} else {
			$("#sel_role_tc").append('<option value="'+value.id+'">'+value.id+' ('+value.name+')</option>');
		}
	});
}
...
function manageOptionHeaderParameterCreate(data) {
	$("#sel_parameter_tc_create").empty();
	$("#sel_parameter_tc_create").append('<option value="" selected>--- Please select ---</option>');
	$.each( data, function( key, value ) {
		$("#sel_parameter_tc_create").append('<option value="'+value.id+'">'+value.domain+' / '+value.name+'</option>');
	});
...
function manageOptionHeaderParameterRoleCreate(data) {
	$("#sel_role_tc_create").empty();
	$("#sel_role_tc_create").append('<option value="" selected>--- Please select ---</option>');
	$.each( data, function( key, value ) {
		$("#sel_role_tc_create").append('<option value="'+value.id+'">'+value.domain+' / '+value.name+' ('+value.id+')</option>');
	});
}
