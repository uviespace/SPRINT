...
$import_derived_selected = isset($_POST['include_derived_packets']) ? 1 : 0;
...
if (isset($_POST['import'])) {
	...
	if (isset($_POST['sel_services']) && isset($_POST['sel_sub_services']))
		$importer->import_services($services, $_POST['sel_services'], $_POST['sel_sub_services'], isset($_POST['include_derived_packets']));
