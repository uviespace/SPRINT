...
<html>
<head>
	<title>CORDET Editor - Services</title>
	...
	<script type="text/javascript" src="js/item-ajax_view-service.js"></script>
</head>
<body>
		...
		<div class="modal fade" id="edit-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
					<form data-toggle="validator" action="api/update_view-service.php" method="put">
