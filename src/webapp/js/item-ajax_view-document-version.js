...
var idDocument = getUrlVars()["idDocument"];
...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-document-version.php?idProject='+idProject+'&idDocument='+idDocument,
		data: {page:page}
	}).done(function(data){
...
function manageDataAll() {
	...
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_view-document-version.php?idProject='+idProject+'&idDocument='+idDocument+'&showAll=1',
		data: {page:page}
	}).done(function(data){
		total_page = 1;
		current_page = page;
...
$("body").on("click",".remove-item",function(){
    ...
    if (confirmation) {
        $.ajax({
            dataType: 'json',
            type:'POST',
            url: url + 'api/delete_view-document-version.php',
            data:{id:id}
        }).done(function(data){
            c_obj.remove();
