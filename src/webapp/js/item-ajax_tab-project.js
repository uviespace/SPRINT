...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_tab-project.php',
		data: {page:page}
	}).done(function(data){
...
$(".crud-submit").click(function(e){
    ...
    if(id != '' && name != '' && desc != '' && isPublic != ''){
        $.ajax({
            dataType: 'json',
            type:'POST',
            url: url + form_action,
            data:{id:id, name:name, desc:desc, isPublic:isPublic, setting:setting}
        }).done(function(data){
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_tab-project.php',
		data:{id:id}
	}).done(function(data){
		c_obj.remove();
