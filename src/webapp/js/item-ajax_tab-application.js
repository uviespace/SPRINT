...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_tab-application.php',
		data: {page:page}
	}).done(function(data){
...
function manageRow(data) {
	...
	$.each( data, function( key, value ) {
	  	...
	  	rows = rows + '<td>'+value.idProject+'</td>';
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_tab-application.php',
		data:{id:id}
	}).done(function(data){
		c_obj.remove();
...
$("body").on("click",".edit-item",function(){
    ...
    var id = $(this).parent("td").data('id');
    var idProject = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").prev("td").text();
    ...
    $("#edit-item").find("input[name='idProject']").val(idProject);
    $("#edit-item").find("input[name='name']").val(name);
	$("#edit-item").find("input[name='desc']").val(desc);
...
$(".crud-submit-edit").click(function(e){
    ...
    var idProject = $("#edit-item").find("input[name='idProject']").val();
