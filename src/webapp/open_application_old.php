...
?>
                ...
                <?php if (doesTableExists($mysqli, "calibration")) { ?>
                <form id="formTypGET" enctype="multipart/form-data" style="background-color: #d1d1d1; padding: 15px 15px 1px 15px;" method="POST" action="open_application_old.php?idProject=<?php echo $idProject; ?>&idApplication=<?php echo $idApplication; ?>&selCalCurve=1">
                  <div class="table" style="margin-bottom:0px;">
                  <div class="table-row">
                      <div class="table-cell" style="width:20%;">
                ...
                <?php if ($idCalCurve > 0) { ?>
                <form id="formActGET" enctype="multipart/form-data" style="background-color: #d1d1d1; padding: 15px 15px 1px 15px;" method="POST" action="open_application_old.php?idProject=<?php echo $idProject; ?>&idApplication=<?php echo $idApplication; ?>&selCalCurve=1&selAction=1">
