...
function manageData() {
	$.ajax({
		dataType: 'json',
		url: url+'api/getData_tab-service.php',
		data: {page:page}
	}).done(function(data){
...
$(".crud-submit").click(function(e){
    ...
    if(id != '' && idStandard != '' && name != '' && desc != '' && type != ''){
        $.ajax({
            dataType: 'json',
            type:'POST',
            url: url + form_action,
            data:{id:id, idStandard:idStandard, name:name, desc:desc, type:type, setting:setting}
        }).done(function(data){
...
$("body").on("click",".remove-item",function(){
	...
	$.ajax({
		dataType: 'json',
		type:'POST',
		url: url + 'api/delete_tab-service.php',
		data:{id:id}
	}).done(function(data){
		c_obj.remove();
